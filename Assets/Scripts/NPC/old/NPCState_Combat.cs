...
void AttackPattern_ShortSwings()
{
    ...
    Vector3 bladeProjection = npc.transform.InverseTransformPoint(npc.npcWeaponController.weaponObject.transform.position).normalized;
...
void AttackPattern_PierceEnemy()
{
    ...
    {
        npc.npcWeaponController.PiercingAttack();
